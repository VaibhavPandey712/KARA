...
export function Vision() {
  ...
  return (
    <section className="section vision" id="vision" ref={ref}>
      <div className="container">
        <div className={`vision__inner ${isVisible ? 'vision__inner--visible' : ''}`}>
            ...
            <div className="vision__orbit-container">
              ...
              <div className="vision__ring vision__ring--1">
                {['Edit', 'Post', 'Grow', 'Analyze'].map((label, i) => (
                  <div key={label} className="vision__orbit-dot" style={{ '--orbit-angle': `${i * 90}deg` }}>
                    <span>{label}</span>
                  </div>
                ))}
              </div>
...
export function CTA() {
  ...
  return (
    <section className="section cta" id="contact" ref={ref}>
      <div className="container">
        <div className={`cta__inner ${isVisible ? 'cta__inner--visible' : ''}`}>
          {/* Decorative dots */}
          <div className="cta__dot cta__dot--1" aria-hidden="true" />
          <div className="cta__dot cta__dot--2" aria-hidden="true" />
          ...
          <div className="cta__content">
            ...
            <div className="cta__actions">
              ...
              <a
                ...
                className="btn btn-secondary cta__btn-whatsapp"
              >
            ...
            <div className="cta__trust">
              {[
                { icon: '✓', text: 'Free creator audit' },
                { icon: '✓', text: 'No commitment required' },
                { icon: '✓', text: 'Personalized growth plan' },
              ].map(t => (
                <div key={t.text} className="cta__trust-item">
                  <span className="cta__trust-icon">{t.icon}</span>
                  {t.text}
                </div>
              ))}
            </div>
